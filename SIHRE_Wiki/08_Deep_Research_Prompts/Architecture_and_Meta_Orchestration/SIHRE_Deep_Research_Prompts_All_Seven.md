---
tags: [sihre, deep-research, prompts, chatgpt, architecture, meta-orchestrator]
status: final
source: original
classification: private-sensitive
created: 2026-05-23
updated: 2026-05-23
original_path: SIHRE Framework/Research Reports/deep-research-prompts.md
---
...
**Terminology:**
- **Public framework:** SIHRE — Self-Improving Heterogeneous Reasoning Ensemble
...
- **Whitepaper title:** SIHRE: Meta-Orchestrated Heterogeneous Reasoning for Adaptive Intelligence Under Non-Stationarity
- **Proprietary implementation:** NeuroFusion-13 (internal only)
- **Legacy short academic (superseded):** HRE-13
